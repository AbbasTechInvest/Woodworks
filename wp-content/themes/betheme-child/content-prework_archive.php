    ...
    <div class="post-desc-wrapper bg- has-custom-bg" style="background-color: #419bd5">
        <div class="post-desc" style="padding:25px 25px;">
            ...
            <div class="post-title">
                <h4 class="" itemprop="headline"><a style="color: #1f1a4e; font-size:22px;" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
                <p style="color:#1f1a4e;"><?php /*Instructor: 
                    <b>
                        <?php $instructor = get_field('instructor_name', get_field('prework_instructor'));
                        if ($instructor) {
                            echo $instructor;
                        } else {
                            echo "Not Assigned";
                ...
                Date: <b><?php echo date('D, d M Y', strtotime(get_field('prework_date'))) ?></b>
                <br>Time: <b><?php echo date("h:i a", $start_date) . " - " . date("h:i a", $end_date); ?></b>
                <br>Fee: <b><?php the_field('prework_fee') ?></b>
                <br><b>
                <?php
                    $tags = get_the_tags();
                    if ($tags):
