                ...
                <div class="column mcb-column mcb-item-3qydimjjs one-fourth column_hover_color" style="padding:0.5vh;">
                    <div class="hover_color align_"
                        ...
                        <div class="hover_color_bg"
                            ...
                            <div class="hover_color_wrapper" style="padding:50px 30px 35px;"><img
                                    class="scale-with-grid"
                                    src="http://localhost/woodworks/wp-content/uploads/2024/02/job_10485121.png"
                                    alt="">
                                <hr class="no_line" style="margin: 0 auto 40px auto">

                                <p class="big" style="font-size:1.5em;">Fill the Form</p>
                ...
                <div class="column mcb-column mcb-item-a5lxzum8b one-fourth column_hover_color" style="padding:0.5vh;">
                    <div class="hover_color align_"
                        ...
                        <div class="hover_color_bg"
                            ...
                            <div class="hover_color_wrapper" style="padding:50px 30px 35px;"><img
                                    class="scale-with-grid"
                                    src="http://localhost/woodworks/wp-content/uploads/2024/02/stamp_5442020.png"
                                    alt="">
                                <hr class="no_line" style="margin: 0 auto 40px auto">

                                <p class="big" style="font-size:1.5em;"><span style="color:#300843;">Get Admin Approval</span></p>
                ...
                <div class="column mcb-column mcb-item-bi70y8x6a one-fourth column_hover_color" style="padding:0.5vh;">
                    <div class="hover_color align_"
                        ...
                        <div class="hover_color_bg"
                            ...
                            <div class="hover_color_wrapper" style="padding:50px 30px 35px;"><img
                                    class="scale-with-grid"
                                    src="http://localhost/woodworks/wp-content/uploads/2024/02/payment_10106313.png"
                                    alt="">
                                <hr class="no_line" style="margin: 0 auto 40px auto">
                ...
                <div class="column mcb-column mcb-item-h8mfji2tv one-fourth column_hover_color" style="padding:0.5vh;">
                    <div class="hover_color align_"
                        ...
                        <div class="hover_color_bg"
                            ...
                            <div class="hover_color_wrapper" style="padding:50px 30px 35px;"><img
                                    class="scale-with-grid"
                                    src="http://localhost/woodworks/wp-content/uploads/2024/02/invoice_10353226.png"
                                    alt="">
                                <hr class="no_line" style="margin: 0 auto 40px auto">

                                <p class="big" style="font-size:1.5em;">Get Access</p>
                                <p>Hurry Up! limited seats are available.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="column mcb-column mcb-item-m4iw7v311 one column_divider">
